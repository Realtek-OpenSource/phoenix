...
)
{
	...
	if (channel <= 14) {
		...
		odm_set_bb_reg(dm, 0xcb4, MASKLWORD, 0x7557);
		odm_set_bb_reg(dm, 0xeb4, MASKLWORD, 0x7557);
		...
		odm_set_bb_reg(dm, 0xcb0, 0xffffff, 0x177517);
		odm_set_bb_reg(dm, 0xeb0, 0xffffff, 0x177517);
		odm_set_bb_reg(dm, 0xcb4, MASKLWORD, 0x7575);
		odm_set_bb_reg(dm, 0xeb4, MASKLWORD, 0x7575);
		odm_set_bb_reg(dm, 0xcb8, BIT(5), 0);
		odm_set_bb_reg(dm, 0xeb8, BIT(5), 0);
