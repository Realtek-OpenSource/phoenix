...
int mali_mem_os_alloc_pages(mali_mem_os_mem *os_mem, u32 size)
{
	...
	for (i = 0; i < remaining; i++) {
		...
		gfp_t flags = __GFP_ZERO | __GFP_RETRY_MAYFAIL | __GFP_NOWARN | __GFP_COLD | __GFP_RECLAIM;
#else
		gfp_t flags = __GFP_ZERO | __GFP_REPEAT | __GFP_NOWARN | __GFP_COLD | __GFP_RECLAIM;
#endif
		int err;
