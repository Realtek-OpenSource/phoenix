...
proc pref_set_defaults {} {
  ...
  # robert: 2010031601, set RemoteTCP default host to "localhost"
  #  default port to "10000"
  pref define gdb/load/default-hostname localhost
  pref define gdb/load/default-port [pref get gdb/load/port]
  pref define gdb/load/default-portname 10000
  # 2010031601
