...
enum opt_code
{
  ...
  OPT_mandroid = 1197,                       /* -mandroid */
  OPT_mapcs = 1198,                          /* -mapcs */
  OPT_mapcs_frame = 1199,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1200,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1201,              /* -mapcs-stack-check */
  OPT_march_ = 1202,                         /* -march= */
  OPT_marm = 1203,                           /* -marm */
  OPT_masm_syntax_unified = 1204,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1205,                    /* -mbig-endian */
  OPT_mbionic = 1206,                        /* -mbionic */
  ...
  OPT_mfix_pop_pc = 1212,                    /* -mfix-pop-pc */
  OPT_mfix_vldstr = 1213,                    /* -mfix-vldstr */
  OPT_mflip_thumb = 1214,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1215,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1216,                  /* -mfp16-format= */
  OPT_mfpu_ = 1217,                          /* -mfpu= */
  OPT_mglibc = 1218,                         /* -mglibc */
  /* OPT_mhard_float = 1219, */              /* -mhard-float */
  OPT_mlittle_endian = 1220,                 /* -mlittle-endian */
  OPT_mlong_calls = 1221,                    /* -mlong-calls */
  OPT_mmusl = 1222,                          /* -mmusl */
  OPT_mneon_for_64bits = 1223,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1224,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1225,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1226,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1227,               /* -mprint-tune-info */
  OPT_mpure_code = 1228,                     /* -mpure-code */
  OPT_mrestrict_it = 1229,                   /* -mrestrict-it */
  OPT_msched_prolog = 1230,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1231,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1232,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1233, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1234,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1235,                         /* -mthumb */
  OPT_mthumb_interwork = 1236,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1237,                  /* -mtls-dialect= */
  OPT_mtp_ = 1238,                           /* -mtp= */
  OPT_mtpcs_frame = 1239,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1240,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1241,                         /* -mtune= */
  OPT_muclibc = 1242,                        /* -muclibc */
  OPT_munaligned_access = 1243,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1244,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1245,      /* -mvectorize-with-neon-quad */
  ...
  OPT_shared = 1287,                         /* -shared */
  OPT_shared_libgcc = 1288,                  /* -shared-libgcc */
  /* OPT_specs = 1289, */                    /* -specs */
  OPT_specs_ = 1290,                         /* -specs= */
  OPT_static = 1291,                         /* -static */
  OPT_static_libasan = 1292,                 /* -static-libasan */
  OPT_static_libgcc = 1293,                  /* -static-libgcc */
  OPT_static_libgcj = 1294,                  /* -static-libgcj */
